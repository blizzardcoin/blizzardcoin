...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Blizzardcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"blizzardcointools.com", "dnsseed.blizzardcointools.com"},
    {"blizzardcoinpool.org", "dnsseed.blizzardcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"blizzardcointools.com", "testnet-seed.blizzardcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Blizzardcoin is probably already running."), addrBind.ToString().c_str());
        else
